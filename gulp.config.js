...
module.exports = {
	...
	// Project options.
	projectURL: 'cerealnumber.test', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
    ...
    // JS Polyfill options.
	jsPolyfillSRC: './assets/js/polyfill/*.js', // Path to JS custom scripts folder.
	jsPolyfillDestination: './dist/js/vendor/', // Path to place the compiled JS custom scripts file.
	jsPolyfillFile: 'polyfill', // Compiled JS custom file name. Default set to custom i.e. custom.js.

	//Modernizr options.
	ModernizrDestination: './assets/js/vendor/', // Path to place the compiled JS custom scripts file.
